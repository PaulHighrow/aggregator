...
const StreamDeutschA2Sprechclub = () => {
  ...
  useEffect(() => {
    document.title = 'Deutsch A2 Speaking Club | AP Education';
            ...
            <StreamsBackgroundWrapper>
              ...
              !links.trials_de.includes('youtu.be')
                ? window.location.replace(
                    'https://us06web.zoom.us/j/88285400596?pwd=ISl2FqPY6oSGtrXgB9nraYtv8fT3HY.1#success'
                  )
                : null}
              {height > width && (
                <ChatBox
...
export default StreamDeutschA2Sprechclub;
