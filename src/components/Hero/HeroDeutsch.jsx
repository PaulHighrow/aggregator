      ...
      <Box>
        ...
        <Description>
          <span>
            ...
            {isMore ? '!' : '! Обравши наш онлайн-курс німецької мови...'}
          </span>
          <DescriptionMoreText
          ...
          >
            ...
            <DescriptionSiteText>
              ...
              формат вивчення німецької мови. У Вас буде можливість обрати
              зручний формат навчання: самостійне вивчення, навчання в групах
              або індивідуальне з репетитором.{' '}
            </DescriptionSiteText>
            <DescriptionSiteText>
              Наше навчання підходить як для дорослих, так і для дітей. Ми
