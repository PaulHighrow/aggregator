...
export const DesktopSwiperDe = ({ toggleModal }) => {
        ...
        <SwiperSlide style={{ maxWidth: '360px' }}>
          <StyledSlide data-id={0} onClick={handleToggleModal}>
            <MarqueeChildNew>
              ...
              >
                <source
                  src="https://ap.education/static/video/previews-de/preview1.webm"
                  type="video/webm"
                />
                <source
                  src="https://ap.education/static/video/previews-de/preview1.mp4"
                  type="video/mp4"
                />
              </MarqueeVideoNew>
            </MarqueeChildNew>
        ...
        <SwiperSlide style={{ maxWidth: '360px' }}>
          <StyledSlide data-id={1} onClick={handleToggleModal}>
            <MarqueeChildNew>
              ...
              >
                <source
                  src="https://ap.education/static/video/previews-de/preview2.webm"
                  type="video/webm"
                />
                <source
                  src="https://ap.education/static/video/previews-de/preview2.mp4"
                  type="video/mp4"
                />
              </MarqueeVideoNew>
            </MarqueeChildNew>
        ...
        <SwiperSlide style={{ maxWidth: '360px' }}>
          <StyledSlide data-id={2} onClick={handleToggleModal}>
            <MarqueeChildNew>
              ...
              >
                <source
                  src="https://ap.education/static/video/previews-de/preview3.webm"
                  type="video/webm"
                />
                <source
                  src="https://ap.education/static/video/previews-de/preview3.mp4"
                  type="video/mp4"
                />
              </MarqueeVideoNew>
            </MarqueeChildNew>
        ...
        <SwiperSlide style={{ maxWidth: '360px' }}>
          <StyledSlide data-id={3} onClick={handleToggleModal}>
            <MarqueeChildNew>
              ...
              >
                <source
                  src="https://ap.education/static/video/previews-de/preview4.webm"
                  type="video/webm"
                />
                <source
                  src="https://ap.education/static/video/previews-de/preview4.mp4"
                  type="video/mp4"
                />
              </MarqueeVideoNew>
            </MarqueeChildNew>
        ...
        <SwiperSlide style={{ maxWidth: '360px' }}>
          <StyledSlide data-id={4} onClick={handleToggleModal}>
            <MarqueeChildNew>
              ...
              >
                <source
                  src="https://ap.education/static/video/previews-de/preview5.webm"
                  type="video/webm"
                />
                <source
                  src="https://ap.education/static/video/previews-de/preview5.mp4"
                  type="video/mp4"
                />
              </MarqueeVideoNew>
            </MarqueeChildNew>
